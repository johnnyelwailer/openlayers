 ...
 *   * `['zoom']` The current zoom level (WebGL and WebGPU).
 *   * `['line-metric']` returns the M component of the current point on a line (WebGL and WebGPU); in case where the geometry layout of the line
