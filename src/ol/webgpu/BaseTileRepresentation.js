/**
 * @module ol/webgpu/BaseTileRepresentation
 */
 ...
 * @property {import("./Helper.js").default} helper WebGPU helper.
 * @property {number} [gutter=0] The size in pixels of the gutter around image tiles to ignore.
 */

/**
 * @classdesc
 * Base class for representing a tile in a WebGPU context.
...
class BaseTileRepresentation extends EventTarget {
  ...
  constructor(options) {
    ...
    /**
     * @type {import("./Helper.js").default|null}
     * @protected
     */
  ...
  /**
   * @param {import("./Helper.js").default|null} helper The WebGPU helper.
   */
  setHelper(helper) {
    this.helper = helper;
